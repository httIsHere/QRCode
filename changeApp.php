...
//	include("sql_connection.php");
	...
	if($op == 1){
		$sql = "select WeChatAccount, AppId, AppSecret from qydt_ManageUser where ManageUserName ='$user'";
		...
		$id = $_POST['appid'];
		$s = $_POST['apps'];
		$sql = "update qydt_ManageUser set WeChatAccount = '$account', AppId = '$id', AppSecret = '$s' where ManageUserName='$user'";
