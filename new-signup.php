...
$sql = "insert into YQ_ManageUser(ManageUserName, Pwd, WeChatAccount, AppID, AppSecret, status, createTime) value('$user', '$password','".$qyAccount."', '".$qyAppId."','".$qyAppsecret."', 0,".time().")";
